...
export default function AddPetFood({ }: Props) {
    ...
    const handleSubmit = (e: any) => {
        // debugger
        e.preventDefault();
        toast("Pet food details added successfully!");
        ...
        axios.post("http://localhost:8080/petFood/addPetFood", data).then((res: { data: any }) => {
