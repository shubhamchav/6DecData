...
export default function EditPet({ }: Props) {
    ...
    const [checkpetId, setpetId] = useState('');
    ...
    const handleSubmit = (e: any) => {
        // debugger
        e.preventDefault();
        toast("Pet details edited successfully!");

        const data = new FormData();

        data.append('categoryId', checkcategoryId);
        // data.append('petId', checkpetId);
        ...
        axios.put(`http://localhost:8080/pet/updatePet/${petId}`, data).then((res: { data: any }) => {
