...
type StoreFishAccessoriesProps = {
...
export function StoreFishAccessories({ itemId, itemName, itemCategory, itemPrice, itemImage, itemQuantity }: StoreFishAccessoriesProps) {
