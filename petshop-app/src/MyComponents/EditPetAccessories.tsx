...
export default function EditPetAccessories({ }: Props) {
  ...
  const [checkitemId, setitemId] = useState('');
  ...
  const handleSubmit = (e: any) => {
    // debugger
    e.preventDefault();
    toast("Pet accessories details edited successfully!");

    const data = new FormData();

    data.append('itemId', checkitemId);
    ...
    axios.put(`http://localhost:8080/petAccessories/updatePetAccessories/${itemId}`, data).then((res: { data: any }) => {
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    style={{ width: 500 }}
                    name="itemQuantity"
                    placeholder="Accessories Quantity"
                    id="itemQuantity"
                    label="item Quantity"
