...
export default function EditPetCategory({ }: Props) {
    ...
    const handleSubmit = (e: any) => {
        // debugger
        e.preventDefault();
        toast("Pet category details edited successfully!");
        ...
        axios.put(`http://localhost:8080/petCategory/updatePetCategory/${categoryId}`, data).then((res: { data: any }) => {
